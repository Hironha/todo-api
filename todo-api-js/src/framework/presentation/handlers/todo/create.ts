...
import { RawInput, type Input, type Output, type RunError } from '@adapters/dtos/todo/create'
...
export type CreateHandlerOutput = Output['value'] | ApiError<ParseError<Input>['details']>
